...
class Academy_Batch_Three{
    ...
    //     $is_showsss= apply_filters( 'academy_show_post_content_qr_code', true);
    //     if ( ! $is_showsss) {
    //         return $content;
    //     }
    ...
    //  }
     ...
     private function load_classes() {
        ...
        require_once AB_THREE_PLUGIN_PATH . 'shortcode.php';
     ...
     public function register_activation_hook () {
        ...
        // error_log( var_export( count ( $count_posts ), true ));
